...
@mcp_tool(annotations=requires_permissions().require(Permission.RULE_READ).build())
...
@mcp_tool(annotations=requires_permissions().require(Permission.RULE_MODIFY).build())
